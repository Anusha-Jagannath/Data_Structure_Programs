...
public class DataStructureQueue {
	...
	public static void printCalendarUsingQueue(int day, int days) {
		LinkedList<String> weekDayQueue = new LinkedList<String>();
		LinkedList<String> weekDateQueue = new LinkedList<String>();
		String weekdaystr = "SUN MON TUE WED THU FRI SAT";
	...
	public static void printCalendarUsingQueueDoubleStack(int day, int days) {
		LinkedList<String> weekDayQueue = new LinkedList<String>();
		LinkedList<String> weekDayStack1 = new LinkedList<String>();
		LinkedList<String> weekDayStack2 = new LinkedList<String>();
		LinkedList<String> weekDateQueue = new LinkedList<String>();
		LinkedList<String> weekDateStack1 = new LinkedList<String>();
		LinkedList<String> weekDateStack2 = new LinkedList<String>();
		String weekdaystr = "SUN MON TUE WED THU FRI SAT";
		String[] weekdaystrarr = weekdaystr.split(" ");
		for (int i = 0; i < weekdaystrarr.length; i++) {
			weekDayQueue.enQueue(weekdaystrarr[i]);
		...
		for (int i = 0; i < weekdaystrarr.length; i++) {
			...
			weekDayStack1.add(str);
		}
		//weekDayStack1.show();
		for (int i = 0; i < weekdaystrarr.length; i++) {
			if (!weekDayStack1.isEmpty()) {
				weekDayStack2.add((String) weekDayStack1.peek());
				weekDayStack1.pop();
			}
